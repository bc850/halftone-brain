...
class ClearPreferredOrganizationProductSourceRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return $this->user()?->can('clearPreferred', [OrganizationProductSource::class, $organizationProduct]) ?? false;
    }
