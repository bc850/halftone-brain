...
test('phase 0e migrations roll back and remigrate cleanly', function () {
    ...
    // Phase 2E.1 (1) + Phase 2D.1 (6) + Phase 2C.1 (6) + Phase 2B.1 (4) + Phase 2A (4) + Phase 1C.7D (1) + Phase 1C.7A (4) + Phase 1C.6A (2) + Phase 1C.4 (3) + Phase 1A (2) + 0F drop + three 0E hardening migrations.
    Artisan::call('migrate:rollback', ['--step' => 37, '--force' => true]);
