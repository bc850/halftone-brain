...
{
    // Phase 2E.3A (2) + Phase 2E.1 (1) + Phase 2D.1 (6) + Phase 2C.1 (6) + Phase 2B.1 (4) + Phase 2A (4) + Phase 1C.7D (1) + Phase 1C.7A (4).
    Artisan::call('migrate:rollback', ['--step' => 28, '--force' => true]);
}
